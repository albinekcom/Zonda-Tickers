...
final class TickerNameValidatorTests: XCTestCase {
    ...
    func testIsValid() {
        ...
        XCTAssertTrue(TickerNameValidator.isValid(name: "NEUPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "NEUEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "NEUUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "NEUBTC"))
        
        XCTAssertTrue(TickerNameValidator.isValid(name: "TRXPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "TRXEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "TRXUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "TRXBTC"))
        
        XCTAssertTrue(TickerNameValidator.isValid(name: "AMLTPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "AMLTEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "AMLTUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "AMLTBTC"))
        
        XCTAssertTrue(TickerNameValidator.isValid(name: "EXYPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "EXYEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "EXYUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "EXYBTC"))
        
        XCTAssertTrue(TickerNameValidator.isValid(name: "BOBPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "BOBEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "BOBUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "BOBBTC"))
        
        XCTAssertTrue(TickerNameValidator.isValid(name: "LMLPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "LMLBTC"))

        XCTAssertTrue(TickerNameValidator.isValid(name: "XLMPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "XLMEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "XLMUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "XLMBTC"))

        XCTAssertTrue(TickerNameValidator.isValid(name: "XBXBTC"))

        XCTAssertTrue(TickerNameValidator.isValid(name: "BCPPLN"))

        XCTAssertTrue(TickerNameValidator.isValid(name: "BSVPLN"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "BSVEUR"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "BSVUSD"))
        XCTAssertTrue(TickerNameValidator.isValid(name: "BSVBTC"))
